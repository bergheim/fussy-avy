...
(use-package fussy-avy
  :elpaca (:host github :repo "bergheim/fussy-avy")
  :bind (("C-'" . fussy-avy-goto-char-timer))
  ;; Or for Evil users
  ;; :bind (:map evil-normal-state-map ("s" . evil-fussy-avy-goto-char-timer))
  )
#+end_src
...
#+begin_src elisp
(use-package fussy-avy
  :straight (:host github :repo "bergheim/fussy-avy")
  :bind (("C-'" . fussy-avy-goto-char-timer)))
#+end_src

*** elpaca (without use-package)

#+begin_src elisp
(elpaca (fussy-avy :host github :repo "bergheim/fussy-avy"))
